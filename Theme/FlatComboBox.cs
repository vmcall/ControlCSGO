...
namespace FlatUI
{
    public class FlatComboBox : ComboBox
    {
        ...
        private Color _BaseColor = Color.FromArgb(21, 164, 250);
        private Color _BGColor = Color.FromArgb(25, 45, 67);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Rectangle Button = new Rectangle(Convert.ToInt32(W - 24), 0, W, H);
            ...
            //-- Lines
            _with16.DrawString("▼", new Font("Segoe UI", 6), Brushes.White, new Point(Width - 12, 16), Helpers.CenterSF);


            //-- Text
            _with16.DrawString(Text, Font, Brushes.White, new Rectangle(5, 1, W, H), new StringFormat { LineAlignment = StringAlignment.Center });
