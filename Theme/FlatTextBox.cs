...
namespace FlatUI
{
    ...
    public class FlatTextBox : System.Windows.Forms.Control
    {
        private int W;
        private int H;
        ...
        private Color _BaseColor = Color.FromArgb(25, 45, 67);
        private Color _TextColor = Color.FromArgb(99, 130, 169);
